...
function crearGaleria() {
    //querySelector(): Seleciona la clase de html
    const galeria = document.querySelector('.galeria-imagenes');

    for(let i = 1; i<=12;i++){
        const imagen = document.createElement('picture');// createElement('picture') -> <picture></picture>
        // innerHTML: El contenido de html
        imagen.innerHTML =`
